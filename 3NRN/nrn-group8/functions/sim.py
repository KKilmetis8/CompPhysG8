...
def run_network(cycle, coreT, initY = None,
    ...
    t_eq: float,
        The approximate time in Gyr where the 1He and 4He become equal.
    savetimes: arr,
        Array containing the times at which the abundances are saved.
    '''
    ...
    return Ys, equality_time / (year * 1e9), savetimes
